%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Master dissertation file for Decory Edwards.
% Based on the JHU dissertation template and adapted to compile imported chapter
% material as one self-contained dissertation project for GitHub and Overleaf.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\usepackage[backend=bibtex, style=authoryear, maxcitenames=2, maxbibnames=99,
...
%%%% ABSTRACT (includes committee as required by JHU)
\include{02-abstract}
