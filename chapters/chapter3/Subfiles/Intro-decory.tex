...
\par The computational implementation of these measures is presented in Subsection~\ref{subsec:compute-measures}, which uses SCF data (1989--2022) for net wealth and gross assets to compare the model-based inequality measures with Black-White median wealth-gap diagnostics.
