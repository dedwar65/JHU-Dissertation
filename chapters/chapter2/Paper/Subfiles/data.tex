...
\par Figure~\ref{fig:39_trust_general_2020_hist} shows the distribution of responses to the generalized-trust question (scale 1--10) for regression-sample respondents in the 2020 interview wave.

\begin{figure}[H]
\centering
\includegraphics[width=0.72\textwidth]{../../Code/Descriptive/Figures/39_trust_general_2020_hist.png}
\caption{Distribution of generalized trust among sample respondents (2020)}
\label{fig:39_trust_general_2020_hist}
\end{figure}
\FloatBarrier

\par Figure~\ref{fig:trust_mean_by_race_eth_2020} summarizes mean generalized trust (1--10) by race and ethnicity in the 2020 interview wave, for respondents with nonmissing trust and race/ethnicity. The pattern is descriptive background for the control set used in the regressions, where race and ethnicity enter as categorical covariates.

\begin{figure}[H]
\centering
\includegraphics[width=0.72\textwidth]{../../Code/Descriptive/Figures/trust_mean_by_race_eth_2020.png}
\caption{Mean generalized trust by race/ethnicity (2020)}
