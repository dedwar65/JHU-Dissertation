...
\InputStataRegTableCompact{Sample Demographics}{tab:39_reg_sample_demographics}{../../Code/Descriptive/Tables/39_reg_sample_demographics.tex}{Column~(1) reports shares for the 2020 cross-section; column~(2) reports shares pooled across all survey years.}
\FloatBarrier
...
\InputStataRegTableCompact{Participation and Portfolio Composition}{tab:41_summary_portfolios}{../../Code/Analysis/Tables/41_table5_summary_portfolios.tex}{All shares are expressed as fractions of gross wealth. Participation is the fraction of person-years with a strictly positive holding. Leverage ratios can exceed one when liabilities exceed gross assets.}
\FloatBarrier
